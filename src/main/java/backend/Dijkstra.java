...
//        }
        ...
        System.out.println("Total costs (taking slider weight into account): " + path.getTotalCost());
        System.out.println("Total elevation (cm): " + path.getTotalElevationCm());
        System.out.println("Total distance (cm): " + path.getTotalDistanceCm());
